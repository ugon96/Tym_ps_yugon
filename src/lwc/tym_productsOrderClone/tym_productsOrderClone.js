...
import productOrderClone from '@salesforce/apex/TYM_ProductsOrderCloneController.productsOrderClone';
...
export default class Tym_partsOrderClone extends NavigationMixin(LightningElement) {
    ...
    onSubmitSave(e) {
        ...
        productOrderClone({recordId : this.recordId, productOrderMap : productOrderMap})
            .then(result => {
